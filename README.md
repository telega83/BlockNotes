...
To see how localizations works please do folowing: Click **Product -> Scheme -> Edit Scheme...**, than select **Run** scheme and select language from **Application Language** drop-down list. Application supports English, Russian and Czech languages. Default language is English.
...
Tapping a cell will open an edit view of corresponding note. Edit view allows to refresh note's text (**GET /notes/{id}** method), to edit its text and to save text chages if they have really took place (**PUT /notes/{id}**).
